        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="banner-shop">
                    <a href="{{ asset('#') }}" class="banner-link">
                ...
                <div class="wrap-shop-control">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="change-display-mode">
                            <a href="{{ asset('#') }}" class="grid-mode display-mode active"><i class="fa fa-th"></i>Grid</a>
                            <a href="{{ asset('list.html') }}" class="list-mode display-mode"><i class="fa fa-th-list"></i>List</a>
                        </div>
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ asset('detail.html') }}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="assets/images/products/digital_20.jpg" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                    </a>
                                </div>
                                <div class="product-info">
                                    <a href="{{ asset('#') }}" class="product-name"><span>Radiant-360 R6 Wireless Omnidirectional Speaker [White]</span></a>
                                    <div class="wrap-price"><span class="product-price">$250.00</span></div>
                                    <a href="{{ asset('#') }}" class="btn add-to-cart">Add To Cart</a>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                    ...
                    <div class="widget-content">
                        <ul class="list-category">
                            <li class="category-item has-child-cate">
                                <a href="{{ asset('#') }}" class="cate-link">Fashion & Accessories</a>
                                <span class="toggle-control">+</span>
                                <ul class="sub-cate">
                                    <li class="category-item"><a href="{{ asset('#') }}" class="cate-link">Batteries (22)</a></li>
                                    <li class="category-item"><a href="{{ asset('#') }}" class="cate-link">Headsets (16)</a></li>
                                    <li class="category-item"><a href="{{ asset('#') }}" class="cate-link">Screen (28)</a></li>
                                </ul>
                            </li>
                            <li class="category-item has-child-cate">
                                <a href="{{ asset('#') }}" class="cate-link">Furnitures & Home Decors</a>
                                <span class="toggle-control">+</span>
                                <ul class="sub-cate">
                                    <li class="category-item"><a href="{{ asset('#') }}" class="cate-link">Batteries (22)</a></li>
                                    <li class="category-item"><a href="{{ asset('#') }}" class="cate-link">Headsets (16)</a></li>
                            ...
                            <li class="category-item has-child-cate">
                                <a href="{{ asset('#"') }} class="cate-link">Digital & Electronics</a>
                                <span class="toggle-control">+</span>
                                <ul class="sub-cate">
                                    <li class="category-item"><a href="{{ asset('#') }}" class="cate-link">Batteries (22)</a></li>
                                    <li class="category-item"><a href="{{ asset('#') }}" class="cate-link">Headsets (16)</a></li>
                            ...
                            <li class="category-item">
                                <a href="{{ asset('#') }}" class="cate-link">Tools & Equipments</a>
                            </li>
                            <li class="category-item">
                                <a href="{{ asset('#') }}" class="cate-link">Kid’s Toys</a>
                            </li>
                            <li class="category-item">
                                <a href="{{ asset('#') }}" class="cate-link">Organics & Spa</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ asset('detail.html') }}" title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                                            <figure><img src="assets/images/products/digital_01.jpg" alt=""></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{ asset('#') }}" class="product-name"><span>Radiant-360 R6 Wireless Omnidirectional Speaker...</span></a>
