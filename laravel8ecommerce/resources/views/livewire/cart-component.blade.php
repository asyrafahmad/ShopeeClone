        ...
        <div class=" main-content-area">
            ...
            <div class="summary">
                ...
                <div class="checkout-info">
                    ...
                    <a class="btn btn-checkout" href="{{ asset('checkout.html') }}">Check out</a>
                    <a class="link-to-shop" href="{{ asset('shop.html') }}">Continue Shopping<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                </div>
